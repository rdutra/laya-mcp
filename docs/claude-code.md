...
Because the model can take tens of seconds to initialize on a cold start, set Claude
Code's MCP startup timeout high enough in the environment that launches Claude Code:
